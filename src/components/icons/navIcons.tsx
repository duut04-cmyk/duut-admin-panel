...
export function DeliveriesNavIcon({ className = "h-5 w-5" }: IconProps) {
  return icon(className, <>
    <path d="M3 6h11l2 4v5a1 1 0 0 1-1 1h-1.5M3 6l1.5-2h7L13 6M3 6v10a1 1 0 0 0 1 1h1" strokeLinecap="round" strokeLinejoin="round" />
...
export function IntegrationsNavIcon({ className = "h-5 w-5" }: IconProps) {
  return icon(className, <>
    ...
    <path d="M12 8h3a1 1 0 0 1 1 1v2M12 12h3a1 1 0 0 0 1-1V9M8 12H5a1 1 0 0 1-1-1V9M8 8H5a1 1 0 0 0-1 1v2" strokeLinecap="round" />
  </>);
}
