...
const features = [
  {
    ...
    description:
      "Access the best rates and services from leading logistics providers.",
  ...
  },
  {
    ...
    description:
      "Stay updated with live tracking and proactive notifications.",
    iconBg: "bg-emerald-50 text-emerald-600",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M12 3l7 4v6c0 3.5-2.8 6.5-7 8-4.2-1.5-7-4.5-7-8V7l7-4z" strokeLinejoin="round" />
  ...
  },
  {
    ...
    description:
      "Book deliveries instantly or schedule for your convenience.",
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden="true">
        <path d="M8 5a4 4 0 0 1 8 0v1a3 3 0 0 1 3 3v1a3 3 0 0 1-3 3h-1" strokeLinejoin="round" />
        ...
        <path d="M6 11.5h1.5M16.5 11.5H18M7 14h1M16 14h1" strokeLinecap="round" opacity="0.75" />
      </svg>
    ),
  },
];
    ...
    <section className="relative z-10 w-full max-w-[460px]">
      ...
      <div className="mt-9">
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-muted-foreground">
          One platform. Multiple delivery partners. Intelligent orchestration.
          Faster, safer and more reliable deliveries for your business.
        </p>
      </div>
